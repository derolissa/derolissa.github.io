...
const contentData = {
  ja: {
    ...
    about: `
      ...
      <p>2025年 - 日本を中心としてECでの展開を開始<br></p>
      <div class="section-divider"></div>
      <h3>Atelier & Team</h3>
    ...
    settings: `
      ...
      <div class="lang-buttons">
        ...
        <button class="lang-btn" data-lang="fi">🇫🇮 Suomi (Finnish)</button>
      </div>
    `
  },
  en: {
    ...
    about: `
      ...
      <div class="section-divider"></div>
      <h3>Heritage & Innovation</h3>
      <p>2025 - Launch of e-commerce operations centered in Japan<br></p>
      <div class="section-divider"></div>
      <h3>Atelier & Team</h3>
      <p>We are waiting for people to join our team.</p>
    `,
    products: contentData.ja.products,
    support: `
      <h2>Customer Support</h2>
    ...
    `,
    settings: contentData.ja.settings
  },
  fi: {
    home: `
      <h2>ThLee</h2>
    ...
    about: `
      ...
      <p>2025 - Verkkokaupan käynnistäminen Japaniin keskittyen<br></p>
      <div class="section-divider"></div>
      <h3>Ateljee & Tiimi</h3>
